...
def help(*args):
    commands = [{"command": "hello", "description": "show greeting"},
                ...
                {"command": "cleaner , folder", "description": "sort all file by folder"},
                {"command": "add note, text", "description": "save note with text"},
...
def main():
    ...
    while True:
        ...
        if command in ("goodbye", "close", "exit", "bye", "see you", "bb", "off", "out"):
            print("Goodbye!")
            break
